...
<div class="problem-statement">
                <p></p><p><span style="font-size:18px">A sorted array A[ ] with distinct elements is rotated at some unknown point, the task is to find the minimum element in it.</span></p>
